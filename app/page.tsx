    ...
    <div className="container flex flex-col px-6 py-10 mx-auto space-y-6 lg:h-[32rem] lg:py-16 lg:flex-row lg:items-center">
      <div className="w-full">
        ...
        <div className="flex flex-col items-center mt-16 space-y-8 lg:flex-row lg:items-start lg:space-y-0 lg:space-x-6">
          <Link target='_blank' href="mailto:yulokteen@outlook.com" className="text-gray-400 hover:text-gray-500">
            <Mail size={24} />
          </Link>
          <Link target='_blank' href="https://www.linkedin.com/lokteenyu" className="text-gray-400 hover:text-gray-500">
            <Linkedin size={24} />
          </Link>
          <Link target='_blank' href="https://github.com/l0kt33n" className="text-gray-400 hover:text-gray-500">
            <Github size={24} />
          </Link>
        </div>
      </div>
